                    ...
                    <div class="card shadow-sm rounded-3">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form method="POST" action="{{ route('admin.users.update', $user) }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="rol_id" name="rol_id" class="form-select @error('rol_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($roles as $rol)
                                            {{-- Lógica para seleccionar el rol actual del usuario --}}
                                ...
                                <!-- Password (Opcional) -->
                                <div class="mb-4">
                                    <label for="password" class="form-label fw-medium">Nueva Contraseña (Opcional)</label>
                                    <input id="password" class="form-control @error('password') is-invalid @enderror"
                                           type="password"
                                           name="password"
                                           autocomplete="new-password" />
                                    <div class="form-text">Deja este campo vacío para no cambiar la contraseña.</div>
                                    @error('password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
