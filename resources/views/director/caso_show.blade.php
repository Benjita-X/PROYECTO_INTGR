                                    ...
                                    <div class="mb-4">
                                        ...
                                        <p class="mb-0">
                                            <span class="badge rounded-pill fs-6
                                                @if(strtolower(trim($caso->estado)) == 'sin revision') bg-info-subtle text-info-emphasis border border-info-subtle
                                                @elseif(strtolower(trim($caso->estado)) == 'pendiente') bg-warning-subtle text-warning-emphasis border border-warning-subtle
                    ...
                    <div class="card shadow-sm rounded-3">
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            {{-- 
                              ...
                              Ahora el formulario se muestra si el estado es 'Sin Revision' O 'Pendiente'
                            --}}
                            @php $estadoLimpio = strtolower(trim($caso->estado)); @endphp
                            @if($estadoLimpio == 'sin revision' || $estadoLimpio == 'pendiente')
                                
                                {{-- SI ESTÁ SIN REVISIÓN O PENDIENTE: Muestra el formulario de decisión --}}
                                <form method="POST" action="{{ route('director.casos.validar', $caso) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('motivo_decision') is-invalid @enderror" id="motivo_decision" name="motivo_decision" rows="4" placeholder="Añada un comentario para justificar su decisión (opcional para 'Aceptado', recomendado para 'Rechazado' o 'En Revisión')">{{ old('motivo_decision', $caso->motivo_decision) }}</textarea>
                                    ...
                                    <div class="d-flex flex-wrap gap-2 justify-content-end">
                                        ...
                                        <button type="submit" name="decision" value="Pendiente" class="btn btn-warning">
                            ...
                            @else
                                ...
                                {{-- SI YA NO ESTÁ SIN REVISIÓN NI PENDIENTE: Muestra la decisión tomada --}}
                                <div class="mb-3">
