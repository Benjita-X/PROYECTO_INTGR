                    ...
                    <form method="GET" action="{{ route('director.casos.aceptados') }}">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3 d-flex justify-content-start justify-content-md-end align-self-end gap-2">
                                ...
                                <a href="{{ route('director.casos.aceptados') }}" class="btn btn-secondary">Limpiar</a>
                                
                                {{-- --- ¡BOTÓN AÑADIDO! --- --}}
                                <a href="{{ route('director.casos.aceptados.export', request()->query()) }}" class="btn btn-success">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center p-4">
                                            <span class="text-muted">No se encontraron casos aceptados con los filtros seleccionados.</span>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
